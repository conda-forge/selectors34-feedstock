About selectors34-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/selectors34-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/berkerpeksag/selectors34
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5810&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/selectors34-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `selectors34` can be installed with `conda`:
...
```
mamba install selectors34
```

It is possible to list all of the versions of `selectors34` available on your platform with `conda`:
...
```
mamba search selectors34 --channel conda-forge
```
...
mamba repoquery search selectors34 --channel conda-forge

# List packages depending on `selectors34`:
mamba repoquery whoneeds selectors34 --channel conda-forge

# List dependencies of `selectors34`:
mamba repoquery depends selectors34 --channel conda-forge
```
